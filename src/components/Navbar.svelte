...
<nav class="px-2 sm:px-4 py-2.5 dark:bg-gray-900  w-full    dark:border-gray-600">
    ...
    <a href="/" class="flex items-center m-2 p-0 lg:p-">
        <img src="logo.svg" class=" h-8 m-2 sm:h-10 " alt="Shubhchintak Logo">
    </a>
   ...
   {#if show}
    ...
    <div class="items-center justify-center navside hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col  items-center p-0 lg:px-5 mt-0 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
          <a href="#home" class=" font-urban block py-2 pl-3 pr-4 text-textp bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white" aria-current="page">Home</a>
        </li>
        <li>
          <a href="#about" class="font-urban block py-2 pl-3 pr-4 text-textp rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">About</a>
        </li>
        <li>
          <a href="#services" class="font-urban block py-2 pl-3 pr-4 text-textp rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">Services</a>
        </li>
        <li>
